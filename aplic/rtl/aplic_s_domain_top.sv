...
// Register sourcecfg
logic [NR_SRC:0][10-1:0]     sourcecfg_qi;
...
// Register target
logic [NR_SRC:0][31-1:0]     target_qi;
logic [NR_SRC:0][31-1:0]     target_qo;
logic [NR_SRC:0]             target_we;
logic [NR_SRC:0]             target_re;

// Register idelivery
logic [NR_IDCs-1:0][0:0]     idelivery_qi;
logic [NR_IDCs-1:0][0:0]     idelivery_qo;
logic [NR_IDCs-1:0]           idelivery_we;
logic [NR_IDCs-1:0]           idelivery_re;

// Register iforce
logic [NR_IDCs-1:0][0:0]     iforce_qi;
logic [NR_IDCs-1:0][0:0]     iforce_qo;
logic [NR_IDCs-1:0]           iforce_we;
logic [NR_IDCs-1:0]           iforce_re;

// Register ithreshold
logic [NR_IDCs-1:0][IPRIOLEN-1:0]   ithreshold_qi;
logic [NR_IDCs-1:0][IPRIOLEN-1:0]   ithreshold_qo;
logic [NR_IDCs-1:0]           ithreshold_we;
logic [NR_IDCs-1:0]           ithreshold_re;

// Register topi
logic [NR_IDCs-1:0][25:0]     topi_qi;
logic [NR_IDCs-1:0]           topi_re;

// Register claimi
logic [NR_IDCs-1:0][25:0]     claimi_qi;
